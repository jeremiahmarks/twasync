...
############################################################
##	Fix the client so that a failure to connect to a server 
##	does not crash the program.
############################################################
##
## from a very basic approach, as far as I can see this meets
## the requirements.  
...
if __name__ == '__main__':
    poetry_main()
#    a=PoetrySocket(1,('127.0.0.1', 10000))
...
############################################################
## Example of what happens currently if the connection is not
## successful
##
## jlmarks@NV55C-jlmarks:~/twasync$ python jdavisp3-twisted-intro-8f9d137/twisted-client-1/get-poetry.py 10000
## Traceback (most recent call last):
##   File "jdavisp3-twisted-intro-8f9d137/twisted-client-1/get-poetry.py", line 139, in <module>
##     poetry_main()
##   File "jdavisp3-twisted-intro-8f9d137/twisted-client-1/get-poetry.py", line 125, in poetry_main
##     sockets = [PoetrySocket(i + 1, addr) for i, addr in enumerate(addresses)]
##   File "jdavisp3-twisted-intro-8f9d137/twisted-client-1/get-poetry.py", line 61, in __init__
##     self.sock.connect(address)
